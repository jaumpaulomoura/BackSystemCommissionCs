...
def get_orders_by_month():
    ...
    if cupom_vendedora:
        ...
        results = (
            ...
            .group_by(VwcsEcomPedidosJp.cupom_vendedora, func.to_char(VwcsEcomPedidosJp.data_submissao, 'YYYY-MM'))
            .all()
        )
...
def get_orders_by_day():
    ...
    if cupom_vendedora:
        ...
        results = (
            ...
            .group_by(VwcsEcomPedidosJp.cupom_vendedora, func.to_char(VwcsEcomPedidosJp.data_submissao, 'YYYY-MM-DD'))
            .all()
        )
